...
def make_data_loader(spec, tag=''):
    ...
    loader = DataLoader(dataset, batch_size=spec['batch_size'],
                        shuffle=(tag == 'train'), num_workers=32, pin_memory=True)
    return loader
...
def train(train_loader, model, optimizer):
    ...
    return train_loss.item(), pred_sample
...
def main(config_, save_path):
    ...
    for epoch in range(epoch_start, epoch_max + 1):
        ...
        train_loss, pred_ = train(train_loader, model, optimizer)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='configs/train-odisr-configs/train.yaml')
